...
├── screenshots.ps1            # Regenerates the website screenshots with headless Chrome
├── tools/
│   └── screenshots/           # Screenshot harness: chrome.* stub, mock pages, scenes
...
The screenshots on the landing page are generated, not taken by hand. To refresh them after a UI change:
...
- Saves them as `docs/images/screenshots/<scene>.png` (720x640 at 2x)
