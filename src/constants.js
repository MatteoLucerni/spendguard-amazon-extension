...
const AMAZON_DOMAINS = {
  'www.amazon.com': { currency: 'USD', symbol: '$', totalPattern: 'total', priceFormat: 'us', locale: 'en-US' },
  'www.amazon.co.uk': { currency: 'GBP', symbol: '£', totalPattern: 'total', priceFormat: 'us', locale: 'en-GB' },
  'www.amazon.de': { currency: 'EUR', symbol: '€', totalPattern: 'total|gesamtbetrag|summe', priceFormat: 'eu', locale: 'de-DE' },
  'www.amazon.fr': { currency: 'EUR', symbol: '€', totalPattern: 'total|montant', priceFormat: 'eu', locale: 'fr-FR' },
  'www.amazon.it': { currency: 'EUR', symbol: '€', totalPattern: 'total|totale', priceFormat: 'eu', locale: 'it-IT' },
  'www.amazon.es': { currency: 'EUR', symbol: '€', totalPattern: 'total|importe', priceFormat: 'eu', locale: 'es-ES' },
  'www.amazon.co.jp': { currency: 'JPY', symbol: '¥', totalPattern: '合計|total', priceFormat: 'jp', locale: 'ja-JP' },
  'www.amazon.ca': { currency: 'CAD', symbol: 'CA$', totalPattern: 'total', priceFormat: 'us', locale: 'en-CA' },
  'www.amazon.com.au': { currency: 'AUD', symbol: 'A$', totalPattern: 'total', priceFormat: 'us', locale: 'en-AU' },
  'www.amazon.in': { currency: 'INR', symbol: '₹', totalPattern: 'total', priceFormat: 'us', locale: 'en-IN' },
  'www.amazon.com.br': { currency: 'BRL', symbol: 'R$', totalPattern: 'total', priceFormat: 'eu', locale: 'pt-BR' },
  'www.amazon.nl': { currency: 'EUR', symbol: '€', totalPattern: 'total|totaal', priceFormat: 'eu', locale: 'nl-NL' },
  'www.amazon.se': { currency: 'SEK', symbol: 'kr', totalPattern: 'total|summa', priceFormat: 'eu', locale: 'sv-SE' },
  'www.amazon.pl': { currency: 'PLN', symbol: 'zł', totalPattern: 'total|suma|łącznie', priceFormat: 'eu', locale: 'pl-PL' },
  'www.amazon.sg': { currency: 'SGD', symbol: 'S$', totalPattern: 'total', priceFormat: 'us', locale: 'en-SG' },
  'www.amazon.com.mx': { currency: 'MXN', symbol: 'MX$', totalPattern: 'total|importe', priceFormat: 'us', locale: 'es-MX' },
  'www.amazon.ae': { currency: 'AED', symbol: 'AED', totalPattern: 'total', priceFormat: 'us', locale: 'ar-AE' },
  'www.amazon.sa': { currency: 'SAR', symbol: 'SAR', totalPattern: 'total|الإجمالي', priceFormat: 'us', locale: 'ar-SA' },
  'www.amazon.com.tr': { currency: 'TRY', symbol: '₺', totalPattern: 'total|toplam', priceFormat: 'eu', locale: 'tr-TR' },
  'www.amazon.eg': { currency: 'EGP', symbol: 'EGP', totalPattern: 'total|الإجمالي', priceFormat: 'us', locale: 'ar-EG' },
  'www.amazon.com.be': { currency: 'EUR', symbol: '€', totalPattern: 'total|totaal|totale', priceFormat: 'eu', locale: 'nl-BE' },
};
